...
Завдання 1
Користувач вводить із клавіатури слово для пошуку у файлі та
слово для заміни. Додаток повинен змінити всі входження шуканого
слова на слово для заміни. Статистику роботи додатка потрібно
відобразити на екран.
